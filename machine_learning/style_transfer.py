...
## Parameters 
input_noise = 0.0     # proportion noise to apply to content image
weight_style = 2e2 
weight_mask = None
...
img_content = None 
img_style = None
img_mask = None #1s mark pixels to keep the same

if weight_mask:
    img_content_tensor = tf.convert_to_tensor(img_content)
    img_mask_tensor = tf.convert_to_tensor(img_mask)
