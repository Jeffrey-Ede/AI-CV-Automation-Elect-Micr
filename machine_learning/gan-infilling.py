...
model_dir = "//flexo.ads.warwick.ac.uk/Shared41/Microscopy/Jeffrey-Ede/models/gan-infilling-1/"
...
def generator_architecture(inputs, phase=False, params=None):
    ...
    with tf.variable_scope("GAN/Gen"):
        ...
        enc = conv_block_not_sep(enc, 3, pad_size=(1,1), batch_plus_activ=False)
            ...
            with open(val_log_file, 'a') as val_log:
                ...
                with tf.control_dependencies(update_ops):
                    ...
                    with tf.Session(config=sess_config) as sess: #Alternative is tf.train.MonitoredTrainingSession()
                        ...
                        try:
                            saver.restore(sess, tf.train.latest_checkpoint("X:/Jeffrey-Ede/models/gan-infilling-1/model/"))
                        except:
                        ...
                        while True:
                            ...
                            while time.time()-time0 < modelSavePeriod:
                                ...
                                for j in range(increase_batch_size_by_factor):
                                    ...
                                    mini_batch_dict = {}
                                    __img, __img_truth = sess.run([img, __img_truth])
                                ...
                                if not counter % val_skip_n:
                                    ...
                                    mini_batch_dict = {}
                                    for i in range(batch_size):
                                        __img, __img_truth = sess.run(img[i])
